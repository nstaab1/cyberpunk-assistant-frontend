...
export const CULTURAL_REGIONS: string[] = [
  'North American',
...
export const CLOTHING_STYLES: string[] = [
  'Generic Chic',
  'Leisurewear',
  'Urban Flash',
  'Businesswear',
...
export const AFFECTATIONS: string[] = [
  'Tattoos',
  'Mirrorshades',
  'Ritual scars',
  'Spiked gloves',
...
export const MOST_VALUED_THING: string[] = [
  'Money',
  'Honor',
  'Your word',
  'Honesty',
...
export const FEEL_ABOUT_MOST_PEOPLE: string[] = [
  'I stay neutral.',
  'I stay neutral.',
...
export const MOST_VALUED_PERSON: string[] = [
  'A parent',
  'A brother or sister',
  'A lover',
  'A friend',
...
export const MOST_VALUED_POSSESSION: string[] = [
  'A weapon',
  'A tool',
  'A piece of clothing',
  'A photograph',
...
export const ORIGINAL_FAMILY_BACKGROUNDS: string[] = [
  'Corporate Execs',
  'Corporate Managers',
...
export const CHILDHOOD_ENVIRONMENTS: string[] = [
...
export const FAMILY_CRISES: string[] = [
...
export const FRIEND_RELATIONSHIPS: string[] = [
  'Like an older sibling to you.',
  'Like a younger sibling to you.v',
  'A teacher or mentor.',
...
export const ENEMY_RELATIONSHIPS: string[] = [
  'Ex-friend',
  'Ex-lover',
  'Estranged relative',
  'Childhood enemy',
  ...
  'Partner or coworker',
  'Corporate exec',
  'Government official O',
  'Boosterganger',
];

export const ENEMY_CAUSES: string[] = [
  ...
  `Turned down the other's offer of a job orromantic involvement.`,
...
export const ENEMY_SIZES: string[] = [
...
export const ENEMY_REVENGE_TYPES: string[] = [
  'Avoid the scum',
...
export const LOVE_AFFAIR_TRAGEDIES: string[] = [
